  ...
  return (
    <div className={styles.descriptionReviews}>
      <div className={styles.btn}>
        <div
          className={`${stylesGlobal.button2} ${styles.btnDescription} ${view && stylesGlobal.inActive}`}
          onClick={() => setView(!view)}
        >
          DESCRIPTION
        </div>
        <div
          className={`${stylesGlobal.button2} ${styles.btnReviews} ${!view && stylesGlobal.inActive}`}
          onClick={() => setView(!view)}
        >
          REVIEWS (1)
        </div>
